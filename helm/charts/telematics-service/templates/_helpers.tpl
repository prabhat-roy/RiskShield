{{- define "telematics-service.name" -}}{{- default .Chart.Name .Values.nameOverride | trunc 63 | trimSuffix "-" -}}{{- end -}}
...
{{- end -}}
{{- define "telematics-service.serviceAccountName" -}}
{{- if .Values.serviceAccount.create -}}{{- include "telematics-service.fullname" . -}}
{{- else -}}{{- default "default" .Values.serviceAccount.name -}}{{- end -}}
{{- end -}}
{{- define "telematics-service.labels" -}}
helm.sh/chart: {{ printf "%s-%s" .Chart.Name .Chart.Version | replace "+" "_" }}
app.kubernetes.io/name: {{ include "telematics-service.name" . }}
