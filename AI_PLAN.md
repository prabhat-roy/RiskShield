# AI_PLAN.md â€” RiskShield (Cybersecurity & Insurance Risk Platform)
...
- SOC analysts can't keep up with telemetry volume â€” only ML triage scales.
...
core constraints â€” every AI surface assumes adversaries will probe it.
...
| 5 | UEBA â€” user / entity anomaly | identity, soc | Autoencoder + Isolation Forest | streaming |
...
`risk-architect` â€” researches AI tooling, proposes services, on-boards
...
Spawned per IR ticket â€” runs hypothesis-driven enrichment and writes the
...
Respond â†’ Upgrade â†’ Report. Plus an adversarial-robustness gate:
...
```
ai-platform/
â”œâ”€â”€ cluster: risk-ai-{aws,gcp,azure}      â† cloud GPU pool
â”œâ”€â”€ cluster: risk-ai-air-gapped           â† optional, on-prem for sensitive tenants
â”œâ”€â”€ namespace: risk-ai-control             â† Paperclip
â”œâ”€â”€ namespace: risk-ai-agents              â† OpenClaw runtime
â”œâ”€â”€ namespace: risk-ai-sandbox             â† NemoClaw â€” strict adversarial guardrails
â”œâ”€â”€ namespace: risk-ai-models              â† vLLM, Ollama, LiteLLM, Triton
â”œâ”€â”€ namespace: risk-ai-data                â† Qdrant, Weaviate, MinIO, MLflow
â”œâ”€â”€ namespace: risk-ai-obs                 â† Langfuse, Phoenix
â””â”€â”€ namespace: risk-ai-pipelines           â† Argo Workflows
```
...
| 5 | Per-service Tier-2 agents (soc â†’ ir â†’ underwriting first) |
...
- Cloud infra: $5,500 â€“ $8,500 / month per primary cloud
