# RiskShield â€” top-level Makefile
...
help:
	@echo "RiskShield â€” common targets"
	@echo ""
...
tools-deploy:  ## Deploy every OSS tool registered for RiskShield via ArgoCD
	kubectl apply -f gitops/argocd/applicationsets/all-tools-applicationset.yaml
	argocd appset get riskshield-tools --grpc-web

tools-status:  ## Show sync status of every registered tool
	argocd app list -l "project=riskshield-tools" --grpc-web
