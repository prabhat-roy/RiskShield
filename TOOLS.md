# TOOLS.md — every OSS tool registered for RiskShield

This file is the single inventory of every OSS tool wired up for RiskShield.
...
| domain-oss | [atomic-red-team](domain-oss/atomic-red-team/) | `domain-oss/atomic-red-team/` (doc-only) |
| domain-oss | [caldera](domain-oss/caldera/) | `domain-oss/caldera/` (deployable) |
| domain-oss | [cortex](domain-oss/cortex/) | `domain-oss/cortex/` (deployable) |
| domain-oss | [misp](domain-oss/misp/) | `domain-oss/misp/` (deployable) |
| domain-oss | [opencti](domain-oss/opencti/) | `domain-oss/opencti/` (deployable) |
| domain-oss | [osv-dev](domain-oss/osv-dev/) | `domain-oss/osv-dev/` (doc-only) |
| domain-oss | [thehive](domain-oss/thehive/) | `domain-oss/thehive/` (deployable) |
| domain-oss | [velociraptor](domain-oss/velociraptor/) | `domain-oss/velociraptor/` (deployable) |
